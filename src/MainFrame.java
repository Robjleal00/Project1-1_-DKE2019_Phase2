...
public class MainFrame {
	...
	public static void main(String[] args) throws IOException {
		...
		//@author Nico Sets an image icon for the WINDOW (not the desktiop app)
	...
	private void createUI(JPanel p) throws IOException {
		...
		btnGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				leftPanel.setBounds(100, 120, 120, 80);
				menuPanel.add(leftPanel);
				
				Panel rightPanel = new Panel();
				rightPanel.setBounds(770, 120, 120, 500);//x y width height
				//rightPanel.setBackground(Color.YELLOW);
				menuPanel.add(rightPanel);
				
				Panel middle = new Panel();
				middle.setBounds(300, 120, 400, 500);
				menuPanel.add(middle);
